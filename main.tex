...
\begin{document}
	...
	Das Kommutativgesetz darf nicht angewendet werde. $P \Rightarrow Q \not\equiv Q \Rightarrow P$. \\
	Die Wahrheitswerte können allerdings mithilfe des \glqq nicht\grqq -Operators negiert werden. Da die Konjunktion nur falsch ist, wenn $P$ wahr und $Q$ falsch ist gilt auch: $P \Rightarrow Q \equiv \lnot Q \Rightarrow \lnot P$. \\
	Einfache Aussagen können auch umgeformt werden. \\ So gilt auch $P \equiv \lnot P \Rightarrow (Q \ \& \ \lnot Q)$.
	...
	Die gängigsten werden im folgenden kurz erklärt.
	...
	Mit dem Widerspruchsbeweis beweist man einfache Aussagen. Wenn man zum Beispiel zeigen will, dass $P$ gilt, kann man durch die oben gezeigte Umformung beim Widerspruchsbeweis auch zeigen, dass seine Negation einen Widerspruch erzeugt, also falsch ist. Denn $P \equiv \lnot P \Rightarrow (Q \ \& \ \lnot Q)$ gilt. $(Q \ \& \ \lnot Q)$ ist immer falsch, denn $Q$ kann nicht gleichzeitig richtig und falsch sein. Man könnte also auch schreiben $\lnot P \Rightarrow \bot$.
	Beim Widerspruchsbeweis nimmt man also das Gegenteil der Aussage an und zeigt, dass dies zu einem Widerspruch führt.
	\subsection{Induktionsbeweis}
	Der Induktionsbeweis wird verwendet, um Aussagen für alle Elemente einer bestimmten Menge zu beweisen. Bei der Menge kann es sich um verschiedene Dinge handeln. Meist will man etwas für alle natürlichen Zahlen beweisen, es kann aber jede Menge sein, die sich \emph{induktiv} definieren lässt. Wie die Induktive Mengendefinition funktioniert wird im nächsten Abschnitt erklärt. 
	...
	% \cite{uni-jena}
	\footnote{Vgl. \url{https://www.logik.uni-jena.de/logikmedia/75/einfuehrung-in-das-mathematische-beweisen.pdf} (Stand2.9.25)}
	...
	Da bei einer und-verknüpfung beide Aussage wahr sein müssen, ist die Konjunktion falsch, da die Aussage \glqq 4 ist eine Primzahl\grqq \ falsch ist.
	\footnote{Vgl. \url{https://www.logik.uni-jena.de/logikmedia/75/einfuehrung-in-das-mathematische-beweisen.pdf} (Stand 2.9.25)}
	\end{comment}
	...
	Der vollständige Induktionsbeweis besteht aus zwei Schritten, dem \emph{Induktionsanfang} und dem \emph{Induktionsschritt}.
	Wenn man eine Aussage $A$ für alle natürlichen Zahlen beweisen möchte sehen die beiden Schritte folgendermaßen aus: \\
	
	\begin{enumerate}
		
		\item "`Induktionsanfang: Zeige, dass die Aussage für den Startwert gilt (meistens n=1) 
		\item Induktionsschritt: Dieser besteht aus:
		\begin{itemize}
			\item Induktionsvoraussetzung oder Induktionsannahme: Ab jetzt gehst du davon aus, dass die Aussage für ein beliebiges $n \in \mathbb{N}$ gilt.
			\item Induktionsbehauptung: Hier sagst du einfach, dass die Aussage dann auch für n+1 gelten muss.
			
		\end{itemize}
		Induktionsschluss: Jetzt zeigst du mit Hilfe der Induktionsvoraussetzung, dass die Aussage tatsächlich auch für n+1 gilt."'
		\footnote{\url{https://studyflix.de/mathematik/vollstandige-induktion-2406} (Stand 15.9.25)}
	...
	\]
	zur Berechnung der Summe der ersten n Zahlen aufgestellt. \footnote{Vgl. \url{https://studyflix.de/mathematik/gaussche-summenformel-2408}, (Stand 3.9.25)} \\ 
	\\
	...
	\subsubsection{Induktionsanfang (IA)}
	Zuerst muss die Aussage für die erste natürliche Zahl gezeigt werden.
	...
	\subsubsection{Induktionsschritt (IS)}
	Bei jeder nächsten Gerade, also der $n + 1$-ten kommen maximal $n$ Schnittpunkte dazu, da die $n + 1$-te Gerade maximal alle bisherigen einmal schneiden kann.
	...
	\section{Fazit}
		Die vollständige Induktion ist ein Beweiseverfahren, das sich eignet, um eine Aussage für alle natürliche Zahlen zu beweisen. 	
		Es ist sehr effizient, da man in nur drei Schritten unendlich viele Fälle beweist. So müsste man bei den beiden Beispielen ohne die vollständige Induktion die Aussagen für alle natürlichen Zahlen einzeln beweisen.
